...
I kinda want to explore one more [polygon clipping algorithm](https://en.wikipedia.org/wiki/Weiler%E2%80%93Atherton_clipping_algorithm) that dosen't have the same limitation that the sutherland-hodgeman algo has. For now, I think I'll probably switch to a different topic and come back to it in the future.
